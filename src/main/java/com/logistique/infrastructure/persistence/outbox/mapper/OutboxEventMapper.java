package com.logistique.infrastructure.persistence.outbox.mapper;

import com.logistique.domain.event.shared.DomainEvent;
import com.logistique.infrastructure.persistence.outbox.dto.OutboxEventPayload;
import com.logistique.infrastructure.persistence.outbox.entity.OutboxEventJpaEntity;
import com.logistique.infrastructure.persistence.outbox.exception.OutboxSerializationException;
